...
class _netG(nn.Module):
    def __init__(self, ndf, ngf, nz, nclasses):
        ...
        self.main = nn.Sequential(
            nn.ConvTranspose2d(self.nz+self.ndim*2+nclasses+1, self.ngf*8, 2, 1, 0, bias=False),
    ...
    def forward(self, input):   
        ...
        # pdb.set_trace()
        input = input.view(-1, self.ndim*2+self.nclasses+1, 1, 1)
...
class _netD(nn.Module):
    def __init__(self, ndf, nclasses):
